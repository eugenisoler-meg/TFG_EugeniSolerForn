...
export const getFuncionsByAgrupamentID = async (afiliat_id:string, agrupament_id: string) => fetchQuery('funcionsByAgrupamentID', {'afiliat_id': afiliat_id,'agrupament_id': agrupament_id});
